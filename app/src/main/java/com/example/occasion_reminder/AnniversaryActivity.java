...
public class AnniversaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textView.setText("Upcoming Anniversaries");
        ...
        while (cursor.moveToNext()) {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                    builder = new AlertDialog.Builder(AnniversaryActivity.this);
                    builder.setMessage("Wish Now with :")
                            ...
                            .setNegativeButton("Message", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    shareIntent.putExtra(Intent.EXTRA_TEXT, "Happy Anniversary to Both of You");
